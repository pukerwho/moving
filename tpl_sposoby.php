				...
				<div class="p_page__grid">
					<div class="p_page__item">
						...
						<div class="p_page__item__text mb-5">
							...
							<br><br>Свяжитесь с нами по телефону или через форму заявки. Менеджеры компании
							Woldmoving окажут консультацию и дадут ответы на все Ваши вопросы в области
							перевозок личных вещей авиатранспортом.
						</div>
						<div class="">
							<div class="my-btn modal-price-btn">
								Расчитать стоимость
